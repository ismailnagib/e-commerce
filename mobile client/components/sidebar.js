Vue.component("side-bar", {
  template: `
    <div>
        <div
          id="topbar"
        >
            <div class="topbar-item" v-on:click='menuOpen()'>
                <div class="topbar-icon">
                    <i id="topbar-bars-icon" class="fas fa-bars"></i>
                </div>
            </div>
            <div class="topbar-item">
                <div class="topbar-text">
                    <p id="topbar-title">Shoeka</p>
                </div>
            </div>
            <div id="topbar-cart" class="topbar-item" v-on:click='cartModal()'>
                <div class="topbar-icon">
                    <i id="topbar-cart-icon" class="fas fa-shopping-cart"></i>
                </div>
                <div class="topbar-text">
                    <p id="topbar-itemcount">{{ itemcount }}</p>
                </div>
            </div>
        </div>
        ...
        >
            <div>
                <ul>
                    <li v-on:click='menuClose()'>
                      <div class="sidebar-item">
                        <div class="sidebar-icon" />
                        <div class="sidebar-text" id="sidebar-close-btn">
        ...
        <div id='cartmodal' v-if='openCartModal'>
            <div id='cartcontent'>
                ...
                <div class="row" style="width: 100%" v-else-if='totalsum > 0'>
                    ...
                    <div class="col-12 col-md-6 text-right mb-4"><strong>Rp{{ totalsum | currencySlice}}</strong></div>
  ...
  methods: {
    menuOpen() {
      this.menuopen = !this.openSignModal && !this.openCartModal;
    },
    menuClose() {
      this.menuopen = false;
    },
